...
type Asset struct {
	...
	Address2        string `orm:"size(128)"`
	City            string `orm:"size(128)"`
	State           string `orm:"size(128)"`
	Country         string `orm:"size(128)"`
	PostalCode      string `orm:"size(128)"`
	CurrentOwner    string `orm:"size(128)"`
	RealEstateValue float64
	SellerId        string `orm:"size(128)"`
}
